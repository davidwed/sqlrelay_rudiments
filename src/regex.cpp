...
# if !defined _LIBC && !defined _WIN32
...
void
PREFIX(print_double_string) (const CHAR_T *where, const CHAR_T *string1, int size1, const CHAR_T *string2, int size2)
{
  int this_char;
...
static size_t convert_mbs_to_wcs (CHAR_T *dest, const unsigned char* src,
				  ...
				  char *is_binary);
static size_t
convert_mbs_to_wcs (CHAR_T *dest, const unsigned char *src, size_t len, int *offset_buffer, char *is_binary)
...
PREFIX(regex_compile) (const char *ARG_PREFIX(pattern), size_t ARG_PREFIX(size), reg_syntax_t syntax, struct re_pattern_buffer *bufp)
{
...
static void
PREFIX(insert_op2) (re_opcode_t op, UCHAR_T *loc, int arg1, int arg2, UCHAR_T *end)
{
  register UCHAR_T *pfrom = end;
...
static boolean
PREFIX(at_begline_loc_p) (const CHAR_T *pattern, const CHAR_T *p, reg_syntax_t syntax)
{
...
static boolean
PREFIX(at_endline_loc_p) (const CHAR_T *p, const CHAR_T *pend, reg_syntax_t syntax)
{
  const CHAR_T *next = p;
...
#ifdef WCHAR
static reg_errcode_t
wcs_compile_range (CHAR_T range_start_char, const CHAR_T **p_ptr, const CHAR_T *pend, RE_TRANSLATE_TYPE translate, reg_syntax_t syntax, CHAR_T *b, CHAR_T *char_set)
{
...
static reg_errcode_t
byte_compile_range (unsigned int range_start_char, const char **p_ptr, const char *pend, RE_TRANSLATE_TYPE translate, reg_syntax_t syntax, unsigned char *b)
{
  unsigned this_char;
  const char *p = *p_ptr;
  reg_errcode_t ret;
...
static int
PREFIX(re_search_2) (struct re_pattern_buffer *bufp, const char *string1, int size1, const char *string2, int size2, int startpos, int range, struct re_registers *regs, int stop)
{
  int val;
  register char *fastmap = bufp->fastmap;
...
#ifdef WCHAR
static int
wcs_re_match_2_internal (struct re_pattern_buffer *bufp, const char *cstring1, int csize1, const char *cstring2, int csize2, int pos, struct re_registers *regs, int stop, wchar_t *string1, int size1, wchar_t *string2, int size2, int *mbs_offset1, int *mbs_offset2)
#else /* BYTE */
static int
byte_re_match_2_internal (struct re_pattern_buffer *bufp, const char *string1, int size1, const char *string2, int size2, int pos, struct re_registers *regs, int stop)
#endif /* BYTE */
{
  boolean same_str_p = false;
...
static boolean
PREFIX(group_match_null_string_p) (UCHAR_T **p, UCHAR_T *end, PREFIX(register_info_type) *reg_info)
{
  int mcnt;
...
static boolean
PREFIX(alt_match_null_string_p) (UCHAR_T *p, UCHAR_T *end, PREFIX(register_info_type) *reg_info)
{
  int mcnt;
  UCHAR_T *p1 = p;
...
static boolean
PREFIX(common_op_match_null_string_p) (UCHAR_T **p, UCHAR_T *end, PREFIX(register_info_type) *reg_info)
{
  int mcnt;
  boolean ret;
  int reg_no;
...
static int
PREFIX(bcmp_translate) (const CHAR_T *s1, const CHAR_T *s2, register int len, RE_TRANSLATE_TYPE translate)
{
