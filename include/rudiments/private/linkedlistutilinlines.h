...
enum _linkedlistutil_valuetype_t {
	INTEGER_TYPE=0,
	FLOAT_TYPE,
	STRING_TYPE,
	OBJECT_TYPE
...
RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(
						unsigned char value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(int16_t value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(uint16_t value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(int32_t value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(uint32_t value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(int64_t value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(uint64_t value) {
	return INTEGER_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(float value) {
	return FLOAT_TYPE;
}

RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(double value) {
	return FLOAT_TYPE;
}
...
RUDIMENTS_TEMPLATE_INLINE
enum _linkedlistutil_valuetype_t _linkedlistutil_valuetype(const char *value) {
	return STRING_TYPE;
}
