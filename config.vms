...
AR = @AR@
LDFLAGS = @LDFLAGS@
LINKFLAGS = -rpath $(libdir) -release $(RUDIMENTS_VERSION) -version-info $(SONAME_VERSION_INFO) -no-undefined
MODLINKFLAGS = -rpath $(libdir) -avoid-version -module -no-undefined
LIBPATH = -L
LIB = -l
